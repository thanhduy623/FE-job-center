...
<script setup>
  ...
  // Mảng các biến mock, vừa làm preview vừa dùng v-for render danh sách
  const variables = reactive([
    ...
    { key: '{{ location }}', text: 'Việt Anh 3', description: 'Cơ sở làm việc' },
    { key: '{{ department }}', text: 'Phòng Giáo dục', description: 'Đơn vị quản lý' },
    { key: '{{ address }}', text: 'Phòng Tổ chức Hành chính - Việt Anh 3', description: 'Địa chỉ liên hệ / ký hợp đồng' },
  ])
