...
<script setup>
  ...
  // Các biến mock cho preview, BE sẽ replace thật khi gửi
  const variables = reactive([
    ...
    { key: '{{ scheduleTime }}', text: '08:30, ngày 05/01/2026', description: 'Thời gian phỏng vấn' },
    { key: '{{ location }}', text: 'Phòng Tổ chức Hành chính - Việt Anh 3', description: 'Địa điểm phỏng vấn' },
    { key: '{{ linkConfirm }}', text: '<strong>Tại đây</strong>', description: 'Link xác nhận phỏng vấn (hiển thị "Tại đây")' }
  ])

  // Replace placeholder bằng text mock để preview
